...
<div class="rm-formcard-menu" id="fcm_<?php echo $entry->form_id; ?>" data-formid="<?php echo $entry->form_id; ?>" style="visibility:hidden;">
    ...
    <div class="rm-formcard-tabmenu-wrap rm-dbfl">
        <div class="rm-formcard-tabhead-container rm-difl">
            ...
            <ul>
                <li class="rm_formcard_tabhead rm_active_tabhead" data-tabpanel="#rm_fcm_panel_build"><a href="javascript:void(0)"><i class="material-icons">&#xE869;</i><?php _e('Build', 'custom-registration-form-builder-with-submission-manager') ?> </a></li>
                <li class="rm_formcard_tabhead" data-tabpanel="#rm_fcm_panel_config"><a href="javascript:void(0)"><i class="material-icons">&#xE429;</i><?php _e('Configure', 'custom-registration-form-builder-with-submission-manager') ?></a></li>
                <li class="rm_formcard_tabhead" data-tabpanel="#rm_fcm_panel_integrate"><a href="javascript:void(0)"><i class="material-icons">&#xE8C0;</i><?php _e('Integrate', 'custom-registration-form-builder-with-submission-manager') ?></a></li>
                <li class="rm_formcard_tabhead" data-tabpanel="#rm_fcm_panel_publish"><a href="javascript:void(0)"><i class="material-icons">&#xE255;</i><?php _e('Publish', 'custom-registration-form-builder-with-submission-manager') ?></a></li>
            </ul>
            <div class="rm_formcard_tabhead-title"><?php _e('Submissions', 'custom-registration-form-builder-with-submission-manager') ?></div>
            <ul>
                <li class="rm_formcard_tabhead" data-tabpanel="#rm_fcm_panel_manage"><a href="javascript:void(0)"><i class="material-icons">&#xE8F9;</i><?php _e('Manage', 'custom-registration-form-builder-with-submission-manager') ?></a></li>
                <li class="rm_formcard_tabhead" data-tabpanel="#rm_fcm_panel_analyze"><a href="javascript:void(0)"><i class="material-icons">&#xE6C4;</i><?php _e('Analyze', 'custom-registration-form-builder-with-submission-manager') ?></a></li>
                <li class="rm_formcard_tabhead" data-tabpanel="#rm_fcm_panel_automate"><a href="javascript:void(0)"><i class="material-icons">&#xE923;</i><?php _e('Automate', 'custom-registration-form-builder-with-submission-manager') ?></a></li>
            </ul>
