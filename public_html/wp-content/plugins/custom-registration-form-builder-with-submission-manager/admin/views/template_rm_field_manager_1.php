                                                        ...
                                                        <div class="rm-slab-buttons rm-premium-option-popup-wrap">
                                                            ...
                                                            <?php if ($field_data->is_field_primary == 1 && (empty($field_data->is_deletion_allowed)) && strtolower($field_data->field_type)=="username"): ?>
                                                                ...
                                                                <div class="rm-premium-option-popup" style="display:none">
                                                                  ...
                                                                  <span class="rm_buy_pro_inline"><?php printf(__('To unlock removing Username field (and many more features), please upgrade <a href="%s" target="blank">Click here</a>', 'custom-registration-form-builder-with-submission-manager'), 'http://registrationmagic.com/?download_id=317&amp;edd_action=add_to_cart'); ?> </span>
                                                                </div>
