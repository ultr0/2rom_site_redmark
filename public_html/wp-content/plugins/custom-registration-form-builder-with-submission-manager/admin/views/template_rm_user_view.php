                            ...
                            <tr> <td><?php echo $i++; ?></td><td><?php echo $form_name; ?></td><td><?php echo $sub->submitted_on; ?></td><td><a href="?page=rm_submission_view&rm_submission_id=<?php echo $sub->submission_id; ?>&rm_form_id=<?php echo $sub->form_id; ?>"><i class="material-icons"> link </i></a></td><td class="rm-pdf-submission-popup"><span class="rm-pdf-submission"><i class="material-icons"> picture_as_pdf </i> </span>
                                    <div class="rm-lock-tooltip-popup" style="display:none">
                                      <span class="rm-lock-tooltip-popup-nub"></span>  
                                        <span class="rm_buy_pro_inline">To unlock submission PDF downloads (and many more), please upgrade <a href="http://registrationmagic.com/?download_id=317&amp;edd_action=add_to_cart" target="blank">Click here</a> </span>
                                    </div>
