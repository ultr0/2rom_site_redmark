    ...
    public function create_userpassword_field() {
       ...
       // $this->opts['pattern'] = $patt_regex;
        ...
        if ($field_options->en_pass_strength) {
            ...
            wp_add_inline_script('rm_pwd_strength', "jQuery(document).ready(function(){jQuery('#" . $this->opts['id'] . "').password({ shortPass: '" . $field_options->pwd_short_msg . "',badPass: '" . $field_options->pwd_weak_msg . "',goodPass: '" . $field_options->pwd_medium_msg . "',strongPass: '" . $field_options->pwd_strong_msg . "',});})");
        }
