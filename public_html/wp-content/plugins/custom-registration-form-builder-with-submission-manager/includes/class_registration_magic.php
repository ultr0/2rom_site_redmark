...
class Registration_Magic
{
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action('wp_ajax_rm_disable_login_popup', $rm_admin, 'disable_login_popup');
...
//for shortcodes in widgets.
    ...
    public function define_global_hooks()
    {
        ...
        $this->loader->add_action('clean_user_online_status',$this,'clean_user_online_status');
    }
